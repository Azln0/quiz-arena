...
const initialQuizzes: Quiz[] = [
  ...
  {
    id: "gen_medium",
    title: "Taitus Quiz - medium",
    description: "hard questions that only a real fan can answer.",
    category: "General Gaming",
    difficulty: "medium",
    questions: [
      {
      ...
      {
        id: "gen_medium_2",
        question: "What was taitus's most played artist in 2024",
        options: ["Sexmane", "Turisti", "MELO", "Ice Spice"],
        correctAnswer: "MELO",
        points: 15,
      },
      {
        id: "gen_medium_3",
        question: "When is the birthday of Rontti? (DD/MM)",
        options: ["10/12", "8/23", "11/03", "2/21"],
        correctAnswer: "10/12",
        points: 15,
      },
      {
        id: "gen_medium_4",
        question: "Who's the biggest racist after taitus?",
        options: ["EzP", "Neok", "Furi", "Dima"],
        correctAnswer: "EzP",
        points: 15,
      },
      {
        id: "gen_medium_5",
        question: "Who's the pro player that sneeked into Taitus's group pic",
        options: ["S1mple", "m0nsey", "ZywOo", "Donk"],
        correctAnswer: "Donk",
        points: 15,
      },
    ],
  ...
  {
    id: "gen_hard",
    title: "Taitus Quiz - Hardcore",
    description: "Only taitus and his close ones can solve this",
    category: "General Gaming",
    difficulty: "hard",
    questions: [
      {
        id: "gen_hard_1",
        question: "In what year was taitus rejected by a girl?",
      ...
      {
        id: "gen_hard_2",
        question: "When did taitus have his first beer?",
        options: ["At a wedding", "diddy party", "Student party", "at home"],
        correctAnswer: "Student party",
        points: 20,
      },
      {
        id: "gen_hard_3",
        question: "In what year did taitus try the kylie jenner lip challenge with a glass?",
      ...
      {
        id: "gen_hard_4",
        question: "In the balcony incident at alabnia, after he dropped his shirt to a construction floor, what did he do?",
        options: ["Got a broom and climbed to the roof", "called a worker to give him the shirt", "gave up on the shirt", "got a fishing rod to hook the shirt"],
        correctAnswer: "Got a broom and climbed to the roof",
        points: 20,
      },
      {
        id: "gen_hard_5",
        question: "there is a country taitus didn't visit in one of these, where is it?",
        options: ["Sweden, Greece, America", "Denmark, Greece, Spain", "Netherlands, America, Latvia", "France, Denmark, Greece"],
        correctAnswer: "Denmark, Greece, Spain",
        points: 20,
      },
      {
        id: "gen_hard_6",
        question: "Taitus scammed and then stole a girl's car, is this true?",
        options: ["Yes", "No", "He only scammed her", "He only stole her"],
        correctAnswer: "No",
        points: 20,
      },
    ],
